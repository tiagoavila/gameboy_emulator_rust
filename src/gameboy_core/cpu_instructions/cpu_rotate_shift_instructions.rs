...
impl CpuRotateShiftInstructions for crate::gameboy_core::cpu::Cpu {
    ...
    fn rrca(&mut self) {
        let rotated_value = self.rotate_right_and_update_flags(self.registers.a, false);
        self.registers.a = rotated_value;
    }
    ...
    fn rra(&mut self) {
        let rotated_value = self.rotate_right_and_update_flags(self.registers.a, true);
        self.registers.a = rotated_value;
    }
    ...
    fn rotate_right_and_update_flags(&mut self, mut value: u8, rotate_through_c_flag: bool) -> u8 {
        let bit0 = value & 0b00000001;
        value >>= 1;
