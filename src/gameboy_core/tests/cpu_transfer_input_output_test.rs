...
mod tests {
    ...
    fn test_cp_a_r() {
        ...
        assert_eq!(cpu.flags_register.z, false, "Z flag should be 0");
        assert_eq!(cpu.flags_register.h, true, "H flag should be 1");
        assert_eq!(cpu.flags_register.n, true, "N flag should be 1");
        assert_eq!(cpu.flags_register.c, false, "CY flag should be 0");
    ...
    fn test_inc_r() {
        ...
        let original_cy = cpu.flags_register.c;
        assert_eq!(cpu.flags_register.c, original_cy, "CY flag should not be affected by INC");
    }
    ...
    fn test_dec_r() {
        ...
        let original_cy = cpu.flags_register.c;
        assert_eq!(cpu.flags_register.c, original_cy, "CY flag should not be affected by DEC");
    }
