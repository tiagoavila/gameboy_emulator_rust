...
mod tests {
    ...
    fn test_rla() {
        ...
        assert_eq!(cpu.registers.flags.c, false, "C flag should be 0");
        assert_eq!(cpu.registers.flags.z, false, "Z flag should be 0");
        assert_eq!(cpu.registers.flags.h, false, "H flag should be 0");
        assert_eq!(cpu.registers.flags.n, false, "N flag should be 0");
    }
    ...
    fn test_rla_c_flag_false() {
        ...
        assert_eq!(cpu.registers.flags.c, true, "C flag should be 1");
        assert_eq!(cpu.registers.flags.z, false, "Z flag should be 0");
        assert_eq!(cpu.registers.flags.h, false, "H flag should be 0");
        assert_eq!(cpu.registers.flags.n, false, "N flag should be 0");
    }
    ...
    fn test_rrc_r8() {
        ...
        // When C = 1h
        let mut cpu = Cpu::new();
        cpu.registers.c = 0b00000001; // 0x01
    ...
    fn test_rrc_hl() {
        ...
        let mut cpu = Cpu::new();
        cpu.registers.set_hl(0x1234);
        cpu.memory_bus.write_byte(0x1234, 0b00000000);
