...
pub const INTERRUPTS_HANDLERS_ADDRESSES: [u16; 5] = [
    VBLANK_INTERRUT_HANDLER_ADDRESS,
    LCD_STAT_INTERRUPT_HANDLER_ADDRESS,
    TIMER_INTERRUPT_HANDLER_ADDRESS,
    SERIAL_INTERRUPT_HANDLER_ADDRESS,
    JOYPAD_INTERRUPT_HANDLER_ADDRESS,
];